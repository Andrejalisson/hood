...
<head>
    ...
    <meta name="author" content="André Jálisson" />
    ...
    ============================================= -->
    <title>{{$title}} | Hood Hamburgueria</title>
        ...
        <div class="side-panel-wrap">
            ...
            <div id="q-contact" class="widget quick-contact-widget form-widget">
                ...
                <form id="quick-contact-form" name="quick-contact-form" action="include/form.php" method="post" class="quick-contact-form nobottommargin">
                    ...
                    <button type="submit" id="quick-contact-form-submit" name="quick-contact-form-submit" class="button button-small button-3d nomargin" value="submit">Salvar</button>
                </form>
            ...
            <div id="header-wrap">
                <div class="container">
                    <div class="header-row">
                        ...
                        ============================================= -->
                        <div id="logo">
                            <a href="/" class="standard-logo" data-dark-logo="demos/burger/images/logo-dark.png" data-sticky-logo="demos/burger/images/logo-sticky.png"><img src="demos/burger/images/logo.png" alt="Canvas Logo"></a>
                            <a href="/" class="retina-logo" data-dark-logo="demos/burger/images/logo-dark@2x.png" data-sticky-logo="demos/burger/images/logo-sticky@2x.png"><img src="demos/burger/images/logo@2x.png" alt="Canvas Logo"></a>
                        </div><!-- #logo end -->
                        ...
                        <nav class="primary-menu">
                            ...
                            <ul class="one-page-menu menu-container" data-easing="easeInOutExpo" data-speed="1250" data-offset="60">
                                ...
                                <li class="menu-item"><a class="menu-link" href="#" data-href="#story"><div>Sobre</div></a></li>
                                <li class="menu-item"><a class="menu-link" href="#" data-href="#menu"><div>Cardápio</div></a></li>
                                <li class="menu-item"><a class="menu-link" href="#" data-href="#contact" data-offset="20"><div>Contato</div></a></li>
                                <li class="noborder menu-item"><a class="menu-link" href="tel:+112223333"><div>(85) 9 9135-5198</div></a></li>
                            </ul>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-8 dotted-bg parallax" data-start="top: 0px; opacity: 1" data-400="top: 50px; opacity: 0.3">
                                <div class="emphasis-title" data-animate="fadeInUp">
                                    <div class="before-heading font-secondary color">Simplismente o Melhor</div>
                                    <h1 class="font-border">Hambúrguer!</h1>
                                </div>
                                <p class="lead text-white-50" data-animate="fadeInUp" data-delay="100">O artesanal de Verdade,
                                    <br>Ingredientes Frescos, sem Frescura.</p>
                                <a data-scrollto="#menu" data-easing="easeInOutExpo" data-speed="1250" class="button button-large button-rounded px-4 button-border button-light button-white fw-semibold" data-animate="fadeInUp" data-delay="200">Cardápio</a>
                                <a href="tel:85991355198" class="button button-large button-rounded px-4 button-reveal d-inline-flex tright fw-semibold" data-animate="fadeInUp" data-delay="300"><i class="icon-line-arrow-right"></i><span>Fazer Pedido</span></a>
                            </div>
                        </div>
                    </div>
                </div>
